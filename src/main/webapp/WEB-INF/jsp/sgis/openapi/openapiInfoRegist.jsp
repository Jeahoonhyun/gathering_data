<%--
  Class Name : openapiInfoRegist.jsp
  Description : openapi 정보 등록
...
<head>
	...
	<script type="text/javascript">	    	    
	    function fn_openapi_info_regist() {
	        if (confirm('등록합니까?')) {
	        	if(document.importOpenApiVO.url.value == ""){
	        		alert('URL등록은 필수 입니다.');
	        		return;
	        	}
	            document.importOpenApiVO.action = "<c:url value='/sgis/openapi/openApiInfo.do'/>";
	...
	<article class="container">
		...
		<section id="content" class="content">
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td>
										<form:select path="category" id="category" title="OpenAPI목록">
	                                        <form:option value="API90" label="워크넷구직자료목록"/>
	                                        <form:option value="API91" label="워크넷구직자료상세"/>
	                                    </form:select>
									</td>
								</tr>
								<tr>
									<th scope="row"><label for="w-ref">출처</label></th>
									<td><input type="text" id="sourceIs" name="sourceIs" value="" style="width:550px;"></td>
								</tr>
								<tr>
									<th scope="row"><label for="w-url">URL</label></th>
									<td><input type="text" id="url" name="url" value="" style="width:550px;"></td>
								</tr>
								<tr>
									<th scope="row"><label for="w-url">PORT</label></th>
									<td><input type="text" id="port" name="port" value="" style="width:550px;"></td>
								</tr>
								<tr>
									<th scope="row"><label for="w-key">인증 Key</label></th>
									<td><input type="text" id="apiKey" name="apiKey" value="" style="width:550px;"></td>
								</tr>								
								<tr>
			...
			<div class="bt-area text-right">
				<input type="reset" id="" name="" value="취소" class="bt reset" onclick="javascript:fn_openapi_info('1'); return false;">
				<input type="submit" id="" name="" value="저장" class="bt submit" onclick="javascript:fn_openapi_info_regist(); return false;">
